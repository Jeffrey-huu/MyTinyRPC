...
PATH_OBJ = obj
PATH_SRC = src
PATH_MYTINYRPC = MyTinyRPC
PATH_TESTCASES = testcases

PATH_COMM = $(PATH_SRC)/common
PATH_NET = $(PATH_SRC)/net
PATH_TCP = $(PATH_SRC)/net/tcp
PATH_CODER = $(PATH_SRC)/net/coder
PATH_RPC = $(PATH_SRC)/net/rpc

# will install lib to /usr/lib/libmytinyrpc.a
PATH_INSTALL_LIB_ROOT = /usr/lib

# will install all header file to /usr/include/MyTinyRPC
PATH_INSTALL_INC_ROOT = /usr/include/$(PATH_MYTINYRPC)
...
CXXFLAGS += -I./ -I$(PATH_SRC)	-I$(PATH_COMM) -I$(PATH_NET) -I$(PATH_TCP) -I$(PATH_CODER) -I$(PATH_RPC)
...
LIB_OUT := $(PATH_LIB)/libmytinyrpc.a
...
$(LIB_OUT): $(COMM_OBJ) $(NET_OBJ) $(TCP_OBJ) $(CODER_OBJ) $(RPC_OBJ)
	cd $(PATH_OBJ) && ar rcv libmytinyrpc.a *.o && cp libmytinyrpc.a ../lib/ && rm -f libmytinyrpc.a
...
# to clean 
clean :
	rm -f $(COMM_OBJ) $(NET_OBJ) $(TESTCASES) $(TEST_CASE_OUT) $(PATH_LIB)/libmytinyrpc.a $(PATH_OBJ)/libmytinyrpc.a $(PATH_OBJ)/*.o
...
# uninstall
uninstall:
	rm -rf $(PATH_INSTALL_INC_ROOT) && rm -f $(PATH_INSTALL_LIB_ROOT)/libmytinyrpc.a
